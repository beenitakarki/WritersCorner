...
$query=mysqli_query($con,"update tblposts set Report_count = '0',PostTitle='$posttitle',CategoryId='$catid',SubCategoryId='$subcatid',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status' where id='$postid'");
if($query)
{
$msg="Post updated ";
}
...
<head>
    ...
    <!-- App title -->
    <title>Writers Corner | Add Post</title>
