                                ...
                                <div class="demo-box m-t-20">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table m-0 table-colored-bordered table-bordered-primary">
                                            ...
                                            <tbody>
                                                <?php 
$query=mysqli_query($con,"Select tblcomments.id,  tblcomments.name,tblcomments.postingDate,tblcomments.comment,tblposts.id as postid,tblposts.PostTitle from  tblcomments join tblposts on tblposts.id=tblcomments.postId where tblcomments.status=1 && tblposts.UserId=$uid");
$cnt=1;
...
?></td>
                                                    ...
                                                    <td>
                                                        <?php if($st==0):?>
                                                        <a href="manage-comments.php?uid=<?php echo $uid ?>&disid=<?php echo htmlentities($row['id']);?>"
                                                            title="Disapprove this comment"><i
                                                                class="ion-arrow-return-right"
                                                                style="color: #29b6f6;"></i></a>
                                                        <?php else :?>
                                                        <a href="manage-comments.php?uid=<?php echo $uid ?>&appid=<?php echo htmlentities($row['id']);?>"
                                                        ...
                                                        &nbsp;<a
                                                            href="manage-comments.php?uid=<?php echo $uid ?>&rid=<?php echo htmlentities($row['id']);?>&&action=del">
