...
?>
                                            <tr>
                                                ...
                                                <td><a
                                                        href="edit-post.php?uid=<?php echo $uid ?>&pid=<?php echo htmlentities($row['postid']);?>"><i
                                                            class="fa fa-pencil" style="color: #29b6f6;"></i></a>
                                                    &nbsp;<a
                                                        href="manage-posts.php?uid=<?php echo $uid ?>&pid=<?php echo htmlentities($row['postid']);?>&&action=del"
