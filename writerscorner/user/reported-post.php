...
header('location:index.php');
    ...
    $query=mysqli_query($con,"update tblposts set Is_Active=0, Report_count = 0 where id='$postid'");
    if($query)
    {
    //$msg="Post deletedsdasdas ";
    }
    else{
...
?>
                                                <tr>
                                                    ...
                                                    <td><a
                                                            href="edit-trashpost.php?uid=<?php echo $uid ?>&pid=<?php echo htmlentities($row['postid']);?>"><i
                                                                class="fa fa-pencil" style="color: #29b6f6;"></i></a>
                                                        &nbsp;<a
                                                            href="reported-post.php?uid=<?php echo $uid ?>&pid=<?php echo htmlentities($row['postid']);?>&&action=del"
