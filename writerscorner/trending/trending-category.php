...
?>
            ...
            <h1 style="color:#0C6980;font-size:3em;font-weight: bolder">Top Trending
...
$query=mysqli_query($con,"select tblposts.id as pid,tblposts.PostTitle as posttitle,view_count,like_count,tblposts.PostImage,tblcategory.CategoryName as category,tblsubcategory.Subcategory as subcategory,tblposts.PostDetails as postdetails,tblposts.PostingDate as postingdate,tblposts.PostUrl as url from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join  tblsubcategory on  tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.CategoryId='".$_SESSION['catid']."' and tblposts.Is_Active=1 order by tblposts.view_count desc LIMIT $offset, $no_of_records_per_page");
