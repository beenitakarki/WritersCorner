...
{
    $id=intval($_GET['pid']);
    $restoremsg="Post restored successfully";
}
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="alert alert-success" role="alert">
                                <?php echo htmlentities($restoremsg);?>
                            </div>
                            <?php } ?>
...
?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="trash-posts.php?uid=<?php echo $uid ?>&pid=<?php echo htmlentities($row['postid']);?>&&action=restore">
                                                            <i class="ion-arrow-return-right"
                                                                title="Restore this Post"></i></a>
                                                        &nbsp;
                                                        <a
                                                            href="trash-posts.php?uid=<?php echo $uid ?>&presid=<?php echo htmlentities($row['postid']);?>&&action=perdel"><i
