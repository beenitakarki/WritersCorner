...
<body>
    ...
    <div class="container">
        ...
        <div class="row" style="margin-top: 4%">
            ...
            <!--title-->
            <!-- <h1 style="color:#0C6980;font-size:3em;font-weight: bolder">Most Liked list of Posts</h1> -->
            <!-- Blog Entries Column -->
            <div class="col-md-8">
                <!-- Blog Post -->
                <?php 
